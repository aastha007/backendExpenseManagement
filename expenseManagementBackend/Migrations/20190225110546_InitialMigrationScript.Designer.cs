...
namespace expenseManagementBackend.Migrations
{
    ...
    [Migration("20190225110546_InitialMigrationScript")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("expenseManagementBackend.Models.Expense", b =>
                {
                    b.HasOne("expenseManagementBackend.Models.ExpenseCategory", "ExpenseCategory")
                        .WithMany()
                        .HasForeignKey("EC_ID")
            ...
            modelBuilder.Entity("expenseManagementBackend.Models.Income", b =>
                {
                    b.HasOne("expenseManagementBackend.Models.IncomeCategory", "IncomeCategory")
                        .WithMany()
                        .HasForeignKey("IC_ID")
                        .OnDelete(DeleteBehavior.Cascade);
